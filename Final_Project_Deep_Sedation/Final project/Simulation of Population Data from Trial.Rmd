...
function: 
- solving for coefficient given outcome and outputs. 
conditional assumption independence vs correlated variables
...
- dashboard that allows data entry + modelling
...
White <- White %>% 
  mutate( # Age+	55.5 (16.4)
      ...
      # Neuromuscular Blockade	75 (24.8%)
        ...
        # Proportion of days receiving benzodiazepines+	;  32.5 (38.9) MVP Adjusted ; from workbook: Original 30.3±36.7
